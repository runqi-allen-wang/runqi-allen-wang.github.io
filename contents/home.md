...
## 🔍 Research Interests
My research interests broadly lie in **machine learning, statistics, AI agents, and quantitative finance**, with a particular focus on **theoretical decision-making problems** and **AI-driven quantitative research**. On the theoretical side, I am interested in sequential decision-making problems such as multi-armed bandits and reinforcement learning, especially exploration–exploitation trade-offs, reliable learning under data modification, theoretically grounded learning algorithms, and the use of bandit methods to identify and exploit arbitrage opportunities under uncertainty. I am also interested in developing autonomous and human-in-the-loop research agents that can assist with complex quantitative research workflows, including data analysis, factor discovery, model selection, strategy evaluation, and evidence-based decision-making. More broadly, I aim to apply machine learning, statistical methods, and agentic systems to quantitative finance, including data-driven strategy design, financial modeling, and intelligent decision-making in financial markets.
